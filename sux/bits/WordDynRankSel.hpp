...
template <template <size_t> class T, util::AllocType AT = util::MALLOC> class WordDynRankSel : public DynamicBitVector, public Rank, public Select, public SelectZero {
  private:
